...
test.describe('Vendor Onboarding and Management Journey', () => {
  ...
  test('Vendor registers an account', async ({ When, Then, And, page }) => { 
    await When('I navigate to "/signup"', null, { page }); 
