          ...
          <div class="rp-field">
            ...
            <div class="rp-field__input-wrap">
              <input
                ...
                :disabled="isLoading"
              />
              <button type="button" class="rp-field__toggle" @click="showPassword = !showPassword" :aria-label="showPassword ? 'Hide password' : 'Show password'">
            ...
            <div class="rp-strength" v-if="form.password">
