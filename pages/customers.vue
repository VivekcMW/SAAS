  ...
  <main class="mk-page">
    <section class="mk-hero">
      <div class="mk-hero__inner">
        ...
        <h1 class="mk-hero__title">How teams buy smarter with Moonmart</h1>
    ...
    <section class="mk-cta">
      <div class="mk-cta__inner">
        ...
        <p class="mk-cta__lede">If Moonmart changed how your team buys software, we'd love to hear about it.</p>
...
applySEO({
  title: 'Customer stories | Moonmart',
  description: 'Real stories from teams that replaced vendor calls and spreadsheets with Moonmart.',
  canonical: 'https://moonmart.ai/customers',
  ogType: 'website'
})
...
const featured = [
  {
    ...
    quote: 'Moonmart replaced a messy spreadsheet and three Slack threads. We shipped a new CRM in under a month.',
  ...
  },
  {
    ...
    title: 'Passed HIPAA audit with Moonmart as vendor registry',
...
.cs-stat__num { font-family: var(--f-display); font-size: 2.25rem; font-weight: 700; color: var(--mm-gold); margin: 0 0 0.25rem; }
.cs-stat__label { color: var(--mm-slate); font-size: 0.92rem; margin: 0; }

/* Featured grid */
.cs-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 1.25rem; }
.cs-card { background: var(--mm-s2); border: 0.5px solid var(--b1); border-radius: var(--r-xl); padding: 1.75rem 1.5rem; display: flex; flex-direction: column; }
.cs-card__head { display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem; }
.cs-card__size { font-size: 0.8rem; color: var(--mm-slate); }
.cs-card__title { font-family: var(--f-display); font-size: 1.15rem; font-weight: 700; color: var(--mm-pearl); margin: 0 0 1rem; line-height: 1.35; }
.cs-card__quote { font-size: 0.95rem; color: var(--mm-silver); line-height: 1.6; font-style: italic; margin: 0 0 0.75rem; padding-left: 1rem; border-left: 2px solid var(--mm-gold); }
.cs-card__attr { font-size: 0.82rem; color: var(--mm-slate); margin: 0 0 1.25rem; }
.cs-card__kpis { list-style: none; padding: 0; margin: 0 0 1.25rem; border-top: 0.5px solid var(--b1); padding-top: 1rem; flex: 1; }
.cs-card__kpis li { padding: 0.3rem 0 0.3rem 1.25rem; position: relative; color: var(--mm-silver); font-size: 0.88rem; }
.cs-card__kpis li::before { content: '→'; position: absolute; left: 0; color: var(--mm-gold); font-weight: 700; }
.cs-card__link { color: var(--mm-gold); font-weight: 600; font-size: 0.9rem; text-decoration: none; }

/* Filter chips */
.cs-filters { display: flex; flex-wrap: wrap; gap: 0.5rem; justify-content: center; margin-bottom: 2rem; }
.cs-filter { background: var(--mm-s2); border: 0.5px solid var(--b1); padding: 0.5rem 1rem; border-radius: var(--r-sm); color: var(--mm-slate); font-size: 0.85rem; font-weight: 600; cursor: pointer; transition: all 0.15s; }
.cs-filter:hover { border-color: var(--mm-gold); color: var(--mm-gold); }
.cs-filter.is-active { background: var(--mm-gold); color: #0A0700; border-color: var(--mm-gold); }
</style>
