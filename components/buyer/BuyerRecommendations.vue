...
.wizard__q { font-family: 'Poppins', sans-serif; font-size: 1.25rem; font-weight: 700; margin: 0 0 20px; }
...
.wizard__budget { font-family: 'Poppins', sans-serif; font-size: 1.6rem; font-weight: 700; color: var(--bw-primary); text-align: center; }
...
.rec__logo { width: 44px; height: 44px; border-radius: 12px; color: #fff; display: inline-flex; align-items: center; justify-content: center; font-family: 'Poppins', sans-serif; font-weight: 700; font-size: 1.1rem; }
.rec__name { font-family: 'Poppins', sans-serif; font-weight: 700; font-size: 1.05rem; }
