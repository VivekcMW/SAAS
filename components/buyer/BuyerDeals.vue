  ...
  <div class="bw">
    <header class="bw-head">
      <div>
        ...
        <p class="bw-head__sub">Promo codes and discounts for SaaSWorld members. Log-in required to reveal.</p>
      </div>
    </header>
    ...
    <section class="bw-card bw-section" style="background: var(--bw-primary-50); border-color: var(--bw-primary);">
      <div style="display: flex; justify-content: space-between; align-items: center; gap: 16px; flex-wrap: wrap;">
        <div>
          <h3 style="font-family: 'Poppins', sans-serif; margin: 0 0 4px; font-size: 1.05rem;">Get new deals in your inbox</h3>
...
.deal__pct { font-family: 'Poppins', sans-serif; font-weight: 800; font-size: 1.8rem; color: var(--bw-primary); line-height: 1; }
.deal__pct span { display: block; font-size: 0.7rem; letter-spacing: 0.08em; color: var(--bw-text-muted); font-weight: 600; }
.deal__title { font-family: 'Poppins', sans-serif; font-size: 1rem; font-weight: 700; margin: 0; }
