    ...
    <div class="bw-grid bw-grid--main-aside">
      ...
      <aside>
        ...
        <section class="bw-card" style="margin-top: 16px; background: var(--bw-primary-50); border-color: var(--bw-primary);">
          <h3 style="font-family: 'Poppins', sans-serif; margin: 0 0 8px; font-size: 0.95rem;">Verified Buyer badge</h3>
...
.rev-title { font-family: 'Poppins', sans-serif; font-size: 1rem; font-weight: 600; margin: 0 0 6px; }
...
.review-next__logo { width: 32px; height: 32px; border-radius: 8px; color: #fff; display: inline-flex; align-items: center; justify-content: center; font-family: 'Poppins', sans-serif; font-weight: 700; font-size: 0.82rem; }
